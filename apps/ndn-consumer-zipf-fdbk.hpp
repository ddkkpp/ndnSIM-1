...
#ifndef NDN_CONSUMER_ZIPF_FDBK_H_
#define NDN_CONSUMER_ZIPF_FDBK_H_
 ...
 */
class ConsumerZipfFdbk : public ConsumerCbr {
public:
  static TypeId
  GetTypeId();
...
#endif /* NDN_CONSUMER_ZIPF_FDBK_H_ */
